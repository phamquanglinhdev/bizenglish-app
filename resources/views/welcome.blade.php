...
<head>
    ...
    <title>BizEnglish - Education HTML5 Template</title>
        ...
        <div class="row">
            <div class="col-12">
                <nav class="main-nav">
                    <!-- ***** Logo Start ***** -->
                    <a href="#" class="logo">
                        <img src="{{asset("assets/images/templatemo-eduwell.png")}}" alt="BizEnglish Template">
                    </a>
                    <!-- ***** Logo End ***** -->
                    <!-- ***** Menu Start ***** -->
                    <ul class="nav">
            ...
            <div class="col-lg-6 align-self-center">
                <div class="header-text">
                    ...
                    <div class="main-button-gradient">
                        <div class="">
                            <a href="{{route("backpack.dashboard")}}">Join Us Now!</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="owl-service-item owl-carousel">
                    <div class="item">
                        <div class="service-item">
                            ...
                            <h4>Useful Tricks</h4>
                            <p>BizEnglish is the professional HTML5 template for your school or university websites.</p>
                        </div>
                    </div>
                    <div class="item">
                        <div class="service-item">
                            ...
                            <p>You can download and use this BizEnglish Template for your teaching and learning stuffs.</p>
                        </div>
                    </div>
                    <div class="item">
                        <div class="service-item">
...
<section class="contact-us" id="contact-section">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-12">
                <p class="copyright">Copyright © 2022 BizEnglish Co., Ltd. All Rights Reserved.
